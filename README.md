...
入力は手入力が基本です。手順(シートの公開、GitHubへの登録、毎週の入力、数字を見る場所)は、`docs/manual-entry-guide.md` にあります。
ヘルスケアからの自動入力は、SE 3 と Fitbit Air が揃ってから、もう一度考えます(`docs/ios-shortcut-guide.md`)。
